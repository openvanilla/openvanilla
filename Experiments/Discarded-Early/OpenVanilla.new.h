...
enum
{
    ...
    ovExceptionMemory=1,
    ovExceptionBuffer=2,
    ovExceptionNoSupport=3,
    ovExceptionAbstract=4,
...
public:
    ...
    virtual OVTextBar* hide() { return NULL; }
    virtual OVTextBar* show() { return NULL; }
    virtual OVTextBar* update() { return NULL; }
    virtual int onScreen() { return NULL; }
};
...
class OVModule : public OVObject
{
public:
	virtual int identifier(char *s)		{ *s=0; return 0; }
	virtual void initialize(OVDictionary *sharedcfg,
		OVDictionary *localcfg, char *path) { throw ovExceptionAbstract; }
	virtual void terminate(OVDictionary*, OVDictionary)	 
		{ throw ovExceptionAbstract; }
    virtual void update(OVDictionary*, OVDictionary*)
    	{ throw ovExceptionAbstract; }
};
...
{
public:
	virtual OVIMContext *newContext() { throw ovExceptionAbstract; }
	virtual void deleteContext(OVIMContext* s) { delete s; }
};
    
class OVFilter : public OVModule
{
public:
	virtual int filterEvent(OVKeyCode*, OVBuffer*, OVText);
};
