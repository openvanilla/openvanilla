// ATSComponent.c: required glue code to write a text service component
// (here, an input method) under Apple's OS X, using Carbon library.

// Copyright (c) 2004-2005 by the OpenVanilla Project (http://openvanilla.org)
