...
POJHakkaKeySeq::POJHakkaKeySeq()
{
    clear();
}

int POJHakkaKeySeq::isCompose(char c)
{
    if (strchr(toneComposeKey, c)) return 1;
    return 0;
}

int POJHakkaKeySeq::add(char c, int layout)
{   
...
char *POJHakkaKeySeq::compose(char *buf, int asciioutput)
{
